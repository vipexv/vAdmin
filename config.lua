Config = {
  ...
  UseDiscordRestAPI = false, -- Replaces the ACE PermissionSystem with one relying on the Discord REST API where players get their permissions based on their roles.
  DefaultPermissions = {
    Menu = false,
    Kick = false,
    Ban = false,
